...
class _ProfileStudentStep2ScreenState extends State<ProfileStudentStep2Screen> {
  ...
  bool loading = false;
  List<ProjectExperience> _projects = List.empty(growable: true);
                                ...
                                child: Wrap(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      width: w,
                                      height:
                                          _projects[index].readOnly ? 12 : null,
                                                  ...
                                                  child: TextFieldWidget(
                                                      ...
                                                      canRequestFocus:
                                                          !_projects[index]
                                                              .readOnly,
                                                      readOnly: true,
                                                      initialValue: DateFormat("yyyy/MM")
                                    ...
                                    Container(
                                      width: w,
                                      height:
                                          _projects[index].readOnly ? 20 : null,
                                      child: GestureDetector(
                                        onDoubleTap: () {
                                          if (_projects[index].readOnly &&
                                              _projects[index].enabled)
                                    ...
                                    Container(
                                      ...
                                      width: w,
                                      height:
                                          _projects[index].readOnly ? 100 : 200,
                                      child: GestureDetector(
                                        onDoubleTap: () {
                                          if (_projects[index].readOnly &&
                                              _projects[index].enabled)
                                    ...
                                    _projects[index].readOnly
                                        ...
                                        : Container(
                                            ...
                                            child: ChipsInput<Skill>(
                                              ...
                                              suggestionBuilder: (BuildContext
                                                      context,
                                                  ChipsInputState<Skill> state,
                                                  Skill profile) {
                                                return ListTile(
