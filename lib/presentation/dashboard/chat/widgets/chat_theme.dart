...
import 'package:boilerplate/presentation/dashboard/chat/widgets/message/text_message.dart';
...
class DefaultChatTheme extends ChatTheme {
  ...
  const DefaultChatTheme({
    ...
    super.errorIcon,
    super.inputBackgroundColor = primary,
    super.inputSurfaceTintColor = primary,
...
class SystemMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        margin: Chat.theme.systemMessageTheme.margin,
        child: TextMessageText(
          onTapCallback: () {},
          bodyLinkTextStyle: Chat.theme.systemMessageTheme.linkTextStyle,
          bodyTextStyle: Chat.theme.systemMessageTheme.textStyle,
          boldTextStyle: Chat.theme.systemMessageTheme.boldTextStyle,
          codeTextStyle: Chat.theme.systemMessageTheme.codeTextStyle,
          options: options,
          text: message,
        ),
      );
