...
//     return Scaffold(
//       appBar: AppBar(
//           automaticallyImplyLeading: false, title: const Text(Lang.get('P2P calls')),
//       body: BodyLayout(),
//     );
//   }
// }
...
//           return AlertDialog(
//             title: const Text(Lang.get('Login Error"),
//             content:
//                 const Text(Lang.get('Something went wrong during login to ConnectyCube"),
//             actions: <Widget>[
//               TextButton(
//                 child: const Text(Lang.get('OK"),
