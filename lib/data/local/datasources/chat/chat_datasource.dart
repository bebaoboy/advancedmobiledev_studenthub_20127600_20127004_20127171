...
//       return await _chatStore
//           .record(int.parse(project.objectId!))
//           .put(_sembastClient.database, project.toJson());
//     } else {
//       return await _chatStore.add(_sembastClient.database, project.toJson());
//     }
//   }

//   Future<int> count() async {
//     return await _chatStore.count(_sembastClient.database);
//   }
...
//     return await _chatStore.update(
//       _sembastClient.database,
//       project.toJson(),
//       finder: finder,
//     );
...
//     return await _chatStore.delete(
//       _sembastClient.database,
//       finder: finder,
//     );
//   }
