...
import 'package:boilerplate/core/widgets/xmpp/features/servicediscovery/ServiceDiscoverySupport.dart';
...
class ServiceDiscoveryNegotiator extends Negotiator {
  ...
  void sendDiscoInfoResponse(IqStanza request) {
    ...
    for (var featureName in SERVICE_DISCOVERY_SUPPORT_LIST) {
