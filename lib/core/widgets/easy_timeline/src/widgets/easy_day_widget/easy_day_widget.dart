...
class EasyDayWidget extends StatelessWidget {
  ...
  BoxDecoration get _inactiveDayDecoration {
    //T remove `easyDayProps.inactiveDayDecoration` because it is deprecated.
  ...
  BoxDecoration get _activeDayDecoration {
    //T remove `easyDayProps.activeDayDecoration` because it is deprecated.
  ...
  BorderRadius _dayBorderRadius(bool isToday) {
    //T remove `easyDayProps.activeBorderRadius` because it is deprecated.
    final activeBorderRadius =
        _activeDayStyle.borderRadius ?? easyDayProps.activeBorderRadius;
    //T remove `easyDayProps.inactiveBorderRadius` because it is deprecated.
  ...
  DayInfoText _buildMonth(bool isToday) {
    //T remove `easyDayProps.activeMothStrStyle` because it is deprecated.
    ...
    //T remove `easyDayProps.inactiveMothStrStyle` because it is deprecated.
    final inactiveMothStrStyle = _inactiveDayStyle.monthStrStyle ??
        easyDayProps.inactiveMothStrStyle ??
        EasyTextStyles.monthStrStyle;
    //T remove `easyDayProps.todayMonthStrStyle` because it is deprecated.
