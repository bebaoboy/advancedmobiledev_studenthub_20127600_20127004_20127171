...
void main() {
  ...
  testWidgets("Signup Student Widget Test", (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
        ...
        home: const Directionality(
            ...
            child: MediaQuery(
                ...
                child: SignUpStudentScreen()))));

    await tester.pump();

    expect(find.text(Lang.get("signup_student_main_text")), findsOne);
    expect(
        find.byWidgetPredicate((widget) =>
            widget is RoundedButtonWidget &&
            widget.buttonText == Lang.get("signup_student_sign_up")),
        findsAny);

    expect(find.byType(TextFieldWidget), findsExactly(4));
