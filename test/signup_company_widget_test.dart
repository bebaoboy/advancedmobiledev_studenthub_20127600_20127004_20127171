...
void main() {
  ...
  testWidgets("Signup Company Widget Test", (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
        ...
        home: const Directionality(
            ...
            child: MediaQuery(
                ...
                child: SignUpCompanyScreen()))));

    await tester.pump();

    expect(find.text(Lang.get("signup_company_main_text")), findsOne);
    expect(
        find.byWidgetPredicate((widget) =>
            widget is RoundedButtonWidget &&
            widget.buttonText == Lang.get("signup_company_sign_up")),
        findsAny);
